...
import (
	"context"
	"itunes-podcast-api/feeds"
	"itunes-podcast-api/graph/generated"
	"itunes-podcast-api/graph/model"
	"itunes-podcast-api/itunes"
	"itunes-podcast-api/utils"
)

func (r *queryResolver) Search(ctx context.Context, term string) ([]*model.Podcast, error) {
	ias := itunes.ItunesApiServices{}
